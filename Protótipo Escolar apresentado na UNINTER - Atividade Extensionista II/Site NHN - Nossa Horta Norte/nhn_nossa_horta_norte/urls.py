...
urlpatterns = [
    ...
    # Buscar Alimentos
    path('encontrar/alimento', views.buscar_alimento, name='buscar_alimento'),
    path('encontrar/alimento/vtd', views.buscar_alimento_vtd, name='buscar_alimento_vtd'),
    path('todosalimentos', views.todos_alimentos, name='todos_alimentos'),
