...
import { resetPasswordConfirm, logout } from '../features/auth/authSlice';
...
const ResetPasswordPageConfirm = () => {
    ...
    useEffect(() => {
        ...
        if (isSuccess) {
            dispatch(logout());  // Log out the user after a successful password reset
            navigate("/login");  // Redirect the user to the login page
            toast.success("Sua senha foi redefinida com sucesso. Por favor, faça login novamente.");
        }
