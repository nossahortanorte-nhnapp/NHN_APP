...
class ProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = ['id', 'profile_name', 'photo', 'email']

class LikeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Like
        fields = ['id', 'profile', 'like', 'created', 'updated']
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id', 'doacao', 'troca', 'venda', 'title', 'text', 'image', 'data_postagem', 'profile', 'hashtags', 'likes', 'archive']
